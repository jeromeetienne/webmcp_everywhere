...
export class NewAdapter {
	...
	static _renderContext(names: AdapterNames): string {
		return [
			...
			'- Nothing here imports from another adapter, or from anything under `chrome_extension/`. Types come from `adapter_format/`, and waiting and driving come from `@webmcp_everywhere/adapter_toolkit`.',
