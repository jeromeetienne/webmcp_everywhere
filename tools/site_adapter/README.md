...
The folder is named after [`/packages/site_adapter`](../../packages/site_adapter/README.md), because what is checked here is the adapter format that package defines.
