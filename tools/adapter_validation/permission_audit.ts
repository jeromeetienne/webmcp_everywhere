import type { Adapter, AdapterToolDefinition, PermissionClass } from '@webmcp_everywhere/site_adapter';
...
export class PermissionAudit {
	 ...
	 *
	 * `PageDriving` is in this list because every helper in `packages/site_adapter/src/toolkit/page_driving.ts`
