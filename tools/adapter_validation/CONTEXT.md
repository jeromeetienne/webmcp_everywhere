...
- `adapter_schema.ts`: `AdapterSchema`. The version it checks against is `ADAPTER_FORMAT_VERSION`, in [`src/adapter_format/adapter_format_version.ts`](../../src/adapter_format/adapter_format_version.ts).
