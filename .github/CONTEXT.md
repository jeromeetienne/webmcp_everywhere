...
- `release.yml` publishes nothing that has not been started. Both the archive and the npmjs package wait on `tests/webmcp_everywhere/packaged_release.test.ts` having copied the release out of the repository and driven it in a real Chrome.
