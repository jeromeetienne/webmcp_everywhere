...
- `release.yml` publishes nothing that has not been started. Both the archive and the npmjs package wait on `packages/webmcp_everywhere/tests/packaged_release.test.ts` having copied the release out of the repository and driven it in a real Chrome.
