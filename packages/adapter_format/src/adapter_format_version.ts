 ...
 * things that need it can each reach it: the review checks in `tools/adapter_validation/`, which are
 * bundled before they run; `tools/new_adapter.ts`, which Node.js runs straight from TypeScript and so
