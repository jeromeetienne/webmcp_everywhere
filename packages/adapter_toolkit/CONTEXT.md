...
- No relative import leaves this folder, which `tests/source_boundary.test.ts` checks. One that reached back into the repository would work here and break for anybody who installed the package.
