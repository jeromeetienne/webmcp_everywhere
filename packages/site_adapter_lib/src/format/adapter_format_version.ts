 ...
 * things that need it can each reach it: the review checks in `packages/site_adapter_lib/tools/`, which are
 * bundled before they run; `contribs/site_adapters/tools/new_adapter.ts`, which Node.js runs straight from TypeScript and so
