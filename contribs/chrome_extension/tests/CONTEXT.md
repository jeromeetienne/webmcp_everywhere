...
- Loading an adapter with no rebuild is [issue #9](https://github.com/jeromeetienne/webmcp_everywhere/issues/9); the format an outside adapter is written against is [`@webmcp_everywhere/site_adapter_lib`](../../../packages/site_adapter_lib/CONTEXT.md).
