...
- `webmcp_native_host.mjs`: `WebmcpNativeHost` — the program named in the installed host manifest.
- `native_messaging_codec.mjs`: `NativeMessagingCodec` — Chrome's four-byte length-prefixed framing.
