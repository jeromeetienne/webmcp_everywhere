...
- Command to check this folder: `node --test --test-concurrency=1 tests/chrome_extension/*.test.ts`
...
- This folder was `tests/code_from_outside/` until [issue #25](https://github.com/jeromeetienne/webmcp_everywhere/issues/25) named every runner folder after the source folder it checks.
