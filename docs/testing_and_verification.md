...
`npm run test:no_browser` names the six runners that start no browser: [`tests/repository_layout/adapter_registry_sync.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/repository_layout/adapter_registry_sync.test.ts), [`tests/delivery_path/endpoint_file.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/delivery_path/endpoint_file.test.ts), [`tests/installation/native_host_install.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/installation/native_host_install.test.ts), [`tests/installation/npm_package.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/installation/npm_package.test.ts), [`tests/repository_layout/source_boundary.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/repository_layout/source_boundary.test.ts), and [`tests/repository_layout/workspace_packages.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/repository_layout/workspace_packages.test.ts). Those six, plus `npm run typecheck` and `npm run build`, are what [`.github/workflows/checks_without_a_browser.yml`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/.github/workflows/checks_without_a_browser.yml) runs on every pull request, and they answer in about a minute.
