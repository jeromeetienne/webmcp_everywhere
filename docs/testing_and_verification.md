...
| [`tests/repository_layout/adapter_registry_sync.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/repository_layout/adapter_registry_sync.test.ts) | That the registry and the runners still match the folders under `src/site_adapters/`, and that the manifest still names no site |
...
| [`tests/repository_layout/source_boundary.test.ts`](https://github.com/jeromeetienne/webmcp_everywhere/blob/main/tests/repository_layout/source_boundary.test.ts) | Refuses any relative import that leaves [`src/`](https://github.com/jeromeetienne/webmcp_everywhere/tree/main/src), or that leaves a package under [`packages/`](https://github.com/jeromeetienne/webmcp_everywhere/tree/main/packages) |
